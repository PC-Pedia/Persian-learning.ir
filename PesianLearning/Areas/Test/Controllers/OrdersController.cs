...
namespace PesianLearning.Areas.Test.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,UserID,Price,Status,BankGetNumber,BankTransNumber,PostBarCode,Date,Descreption")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,UserID,Price,Status,BankGetNumber,BankTransNumber,PostBarCode,Date,Descreption")] Order order)
        {
            if (id != order.ID)
            {
                return NotFound();
